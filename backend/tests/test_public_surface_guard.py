...
V2_TARGET_ROUTE_ADDITIONS = {
    ...
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/portal/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/portal"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/portal/view"),
    ...
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/evidence-loop/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/evidence-loop"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/regression/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/regression"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/restore/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/human-agent-deepening/restore"),
    ...
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/e2e/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/e2e"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/portal/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/portal"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/portal/view"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/delivery/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/delivery"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/contract/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/contract"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/path-binding/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/path-binding"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/worktree-delivery/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/worktree-delivery"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/surface-baseline/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/external-e2e-portal-delivery/surface-baseline"),
    ...
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/cli-gap/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/cli-gap"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/route-a-evidence/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/route-a-evidence"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/quality-workbench/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/quality-workbench"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/external-path/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/external-path"),
    ("POST", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/release-gate/build"),
    ("GET", "/api/workspaces/{workspace_id}/codebases/{codebase_id}/automated-evidence-closure/release-gate"),
