"""Shared helpers for V2.71-V2.75 agent memory release artifacts."""
...
AGENT_MEMORY_RELEASE_SCHEMA_VERSION = "v2.71-75"
...
def artifact_uri(codebase_id: str, section: str, filename: str) -> str:
    return f"agent_memory_release://{codebase_id}/{section}/{filename}"
...
def base_artifact(
    *,
    ...
    return {
        "schema_version": AGENT_MEMORY_RELEASE_SCHEMA_VERSION,
