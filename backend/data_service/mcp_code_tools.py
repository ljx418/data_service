...
from .mcp_code_human_agent_deepening_tools import HUMAN_AGENT_DEEPENING_TOOL_NAMES, HUMAN_AGENT_DEEPENING_TOOL_SPECS, handle_human_agent_deepening_tool
from .mcp_code_stabilization_e2e_portal_tools import STABILIZATION_E2E_PORTAL_TOOL_NAMES, STABILIZATION_E2E_PORTAL_TOOL_SPECS, handle_stabilization_e2e_portal_tool
from .mcp_code_external_e2e_portal_delivery_tools import EXTERNAL_E2E_PORTAL_DELIVERY_TOOL_NAMES, EXTERNAL_E2E_PORTAL_DELIVERY_TOOL_SPECS, handle_external_e2e_portal_delivery_tool
from .mcp_code_agent_memory_release_tools import AGENT_MEMORY_RELEASE_TOOL_NAMES, AGENT_MEMORY_RELEASE_TOOL_SPECS, handle_agent_memory_release_tool
from .mcp_code_project_acceptance_hardening_tools import PROJECT_ACCEPTANCE_HARDENING_TOOL_NAMES, PROJECT_ACCEPTANCE_HARDENING_TOOL_SPECS, handle_project_acceptance_hardening_tool
from .mcp_code_real_document_acceptance_tools import REAL_DOCUMENT_ACCEPTANCE_TOOL_NAMES, REAL_DOCUMENT_ACCEPTANCE_TOOL_SPECS, handle_real_document_acceptance_tool
from .mcp_code_real_document_full_corpus_release_tools import REAL_DOCUMENT_FULL_CORPUS_RELEASE_TOOL_NAMES, REAL_DOCUMENT_FULL_CORPUS_RELEASE_TOOL_SPECS, handle_real_document_full_corpus_release_tool
from .mcp_code_real_acceptance_closure_tools import REAL_ACCEPTANCE_CLOSURE_TOOL_NAMES, REAL_ACCEPTANCE_CLOSURE_TOOL_SPECS, handle_real_acceptance_closure_tool
from .mcp_code_automated_evidence_closure_tools import AUTOMATED_EVIDENCE_CLOSURE_TOOL_NAMES, AUTOMATED_EVIDENCE_CLOSURE_TOOL_SPECS, handle_automated_evidence_closure_tool
...
} | DEVWIKI_TOOL_NAMES | GRAPH_TOOL_NAMES | QUALITY_TOOL_NAMES | ARCHITECTURE_TOOL_NAMES | DOC_GROUNDED_ARCHITECTURE_TOOL_NAMES | ARCHITECTURE_INTENT_TOOL_NAMES | CODING_AGENT_TOOL_NAMES | PLATFORM_TOOL_NAMES | AGENT_PRODUCTIZATION_TOOL_NAMES | HUMAN_AGENT_DEEPENING_TOOL_NAMES | STABILIZATION_E2E_PORTAL_TOOL_NAMES | EXTERNAL_E2E_PORTAL_DELIVERY_TOOL_NAMES | AGENT_MEMORY_RELEASE_TOOL_NAMES | PROJECT_ACCEPTANCE_HARDENING_TOOL_NAMES | REAL_DOCUMENT_ACCEPTANCE_TOOL_NAMES | REAL_DOCUMENT_FULL_CORPUS_RELEASE_TOOL_NAMES | REAL_ACCEPTANCE_CLOSURE_TOOL_NAMES | AUTOMATED_EVIDENCE_CLOSURE_TOOL_NAMES
...
] + DEVWIKI_TOOL_SPECS + GRAPH_TOOL_SPECS + QUALITY_TOOL_SPECS + ARCHITECTURE_TOOL_SPECS + DOC_GROUNDED_ARCHITECTURE_TOOL_SPECS + ARCHITECTURE_INTENT_TOOL_SPECS + CODING_AGENT_TOOL_SPECS + PLATFORM_TOOL_SPECS + AGENT_PRODUCTIZATION_TOOL_SPECS + HUMAN_AGENT_DEEPENING_TOOL_SPECS + STABILIZATION_E2E_PORTAL_TOOL_SPECS + EXTERNAL_E2E_PORTAL_DELIVERY_TOOL_SPECS + AGENT_MEMORY_RELEASE_TOOL_SPECS + PROJECT_ACCEPTANCE_HARDENING_TOOL_SPECS + REAL_DOCUMENT_ACCEPTANCE_TOOL_SPECS + REAL_DOCUMENT_FULL_CORPUS_RELEASE_TOOL_SPECS + REAL_ACCEPTANCE_CLOSURE_TOOL_SPECS + AUTOMATED_EVIDENCE_CLOSURE_TOOL_SPECS
...
def handle_code_tool(
    ...
    *,
    ...
    if name in HUMAN_AGENT_DEEPENING_TOOL_NAMES:
        return handle_human_agent_deepening_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
    ...
    if name in STABILIZATION_E2E_PORTAL_TOOL_NAMES:
        return handle_stabilization_e2e_portal_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
    ...
    if name in EXTERNAL_E2E_PORTAL_DELIVERY_TOOL_NAMES:
        return handle_external_e2e_portal_delivery_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
    ...
    if name in AGENT_MEMORY_RELEASE_TOOL_NAMES:
        return handle_agent_memory_release_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
    ...
    if name in PROJECT_ACCEPTANCE_HARDENING_TOOL_NAMES:
        return handle_project_acceptance_hardening_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
    ...
    if name in REAL_DOCUMENT_ACCEPTANCE_TOOL_NAMES:
        return handle_real_document_acceptance_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
    ...
    if name in REAL_DOCUMENT_FULL_CORPUS_RELEASE_TOOL_NAMES:
        return handle_real_document_full_corpus_release_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
    ...
    if name in REAL_ACCEPTANCE_CLOSURE_TOOL_NAMES:
        return handle_real_acceptance_closure_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
    ...
    if name in AUTOMATED_EVIDENCE_CLOSURE_TOOL_NAMES:
        return handle_automated_evidence_closure_tool(
            name,
            arguments,
            blocked=blocked,
            envelope=envelope,
