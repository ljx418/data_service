...
| V248-004 | Direct UI route parity or exception | 125/129 | `public_contract_parity.json` | structured_blocker | Phase 125 uses persisted HTML readback route, not an independent UI fact source; final Phase 129 must include parity/exception matrix |
